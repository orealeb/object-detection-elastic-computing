...
public class EC2Controller {
	...
	private static void upload(AmazonS3 s3Client, String bucketName, String keyName, String prediction) {
		PutObjectRequest request = new PutObjectRequest(bucketName, "{ " +  keyName + ", " + prediction + " }", new File(keyName));
        s3Client.putObject(request);
        System.out.println("Uploaded Result");
	}

	private static String performObjectDetection(String keyName) {
		String[] bashScript = new String[] {"./darknet", "detector", "demo", "cfg/coco.data", 
        		"cfg/yolov3-tiny.cfg", "yolov3-tiny.weights",  keyName};
